...
Route::get('/baby-care', [PolaniController::class, 'babycare'])->name('polani.babycare');
Route::get('/bikes', [PolaniController::class, 'bikes'])->name('polani.bikes');
Route::get('/cars', [PolaniController::class, 'cars'])->name('polani.cars');
Route::get('/wishlist', [PolaniController::class, 'wishlist'])->name('polani.wishlist');
