...
<div class="gt-invoice-page-wrapper" style="background-color: #F8F5F0; padding: 40px 0 60px; font-family: 'Plus Jakarta Sans', sans-serif;">
    <div class="section-container" style="max-width: 960px; margin: 0 auto; padding: 0 20px;">
        ...
        <div class="gt-invoice-card" id="printable-invoice" style="background: #FFFFFF; border: 1px solid #EAE1D3; border-radius: 20px; padding: 40px 48px; box-shadow: 0 8px 30px rgba(92, 62, 33, 0.05); position: relative;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 30px; margin-bottom: 24px;">
                ...
                <div style="max-width: 480px;">
                    <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 12px;">
                        <img src="{{ $storeLogo }}" alt="{{ $storeName }}" style="height: 52px; width: auto; object-fit: contain;" onerror="this.onerror=null; this.src='/ghousiatraders/assets/logo.png';">
                        <div>
                            <h2 style="font-family: 'Lora', serif; font-size: 1.6rem; font-weight: 700; color: #3A2518; margin: 0; line-height: 1.1;">{{ $storeName }}</h2>
                    ...
                    <div style="font-size: 0.84rem; color: #55483D; line-height: 1.45;">
                        <p style="margin: 0; font-weight: 700; color: #3A2518;">{{ $storeName }}</p>
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-end; gap: 30px;">
                ...
                <div style="text-align: center; min-width: 180px;">
                    ...
                    <div style="font-size: 0.72rem; color: #7A6E65;">{{ $storeName }}</div>
                </div>
            </div>

        </div>

        <!-- 7. BOTTOM ACTION BUTTONS BAR (Excluded from print) -->
        <div class="gt-invoice-actions-bar" style="margin-top: 28px; display: flex; align-items: center; justify-content: flex-end; gap: 14px;">
...
<style>
    @media print {
        header, footer, nav, .site-header, .site-footer, .gt-invoice-actions-bar, #sf-toast-sound-toggle, #storefront-toast-container {
