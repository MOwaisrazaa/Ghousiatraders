    ...
    <div class="container-fluid py-4">
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <p class="mb-0">Adding question to quiz: {{ $quiz->title }}</p>
            </div>
            <div class="col-md-6 text-end">
                <a href="{{ route('admin.quizzes.edit', $quiz) }}" class="btn btn-secondary">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('admin.quiz-questions.store') }}" method="POST" id="questionForm">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('points') is-invalid @enderror" id="points" name="points" value="{{ old('points', 10) }}" min="1" required>
                    ...
                    <div id="multipleChoiceOptions" class="multiple-choice-hidden">
                        <hr>
                        <h5>Answer Options</h5>
                        <p class="text-muted">Add at least 2 options and mark the correct one.</p>
                        
                        <div id="optionsContainer">
                            <!-- Option template will be cloned here -->
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('admin.quizzes.edit', $quiz) }}" class="btn btn-outline-secondary ms-1">
                            Cancel
                        </a>
                    </div>
                </form>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateOptionIndices() {
                document.querySelectorAll('.option-item').forEach((item, index) => {
                    ...
                    optionTextInput.name = `options[${index}][option_text]`;
