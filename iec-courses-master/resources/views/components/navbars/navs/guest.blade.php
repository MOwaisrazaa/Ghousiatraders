...
<nav
    ...
    <div class="container-fluid ps-2 pe-0">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 d-flex flex-column" href="{{ route('dashboard') }}">
            Appointment & Task Management System
            <span>Fatawa Checking Management System</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                    <a class="btn btn-sm mb-0 me-1 bg-gradient-dark" target="_blank">Task Planner </a>
                </li>
            </ul>
        </div>
    </div>
