    ...
    <div class="container-fluid px-1">
        <a class="navbar-brand font-weight-bolder ms-lg-0 " href="{{ route('dashboard') }}">
            <picture>
                ...
                <img src="{{ asset('assets/img/logos/iec-Logo.png') }}" class="navbar-brand-img" style="height: 30px;" alt="IEC Logo" width="30" height="30" loading="lazy">
            </picture>
            <span class="ms-1">IEC Courses</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            ...
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                    <a href="https://www.youtube.com/playlist?list=PLu0JZwIcuL77VUnQPR1FUDaCG0sNXpEgv" target="_blank"
                        class="btn btn-sm mb-0 bg-gradient-dark">Free Resources</a>
                </li>
            </ul>
        </div>
    </div>
